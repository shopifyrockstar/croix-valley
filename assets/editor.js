      ...
      .on("shopify:section:load", function(event) {
        ...
        switch (type) {
          case "js-section__featured-collection":
            ...
            productCardNodeList.forEach(function (productCard) {
              // don't call productSelect for onboarding
              if(!!productCard.dataset.productId){
                theme.productSelect(productCard.dataset.productId, id, 'card', false);
              }
            });
          ...
          case "js-section__home-product":
            ...
            if (
              ...
              var thisProductId = $(section).find('.js-product-featured').data('product-id');
              theme.productSelect(thisProductId, id, "featured", false);
            }
            theme.runAjaxCart();
          ...
          case "js-section__product-single":
            ...
            var thisProductId = $(section).find('.js-product-single').data('product-id');
            theme.productSelect(thisProductId, id, "single", false);
            ...
            const complementary_products = document.querySelector('.js-complementary-products');

            if (complementary_products) {
              if (document.cookie.split('; ').find((row) => row === 'venue__complementary-products-absent=true')) {
                window.theme.complementary_products_fetch_delay = '1000';
              } else {
                window.theme.complementary_products_fetch_delay = '0';
              }
              document.cookie = "venue__complementary-products-absent=false; SameSite=None; Secure";
            } else {
              document.cookie = "venue__complementary-products-absent=true; SameSite=None; Secure";
            }
          ...
          case "js-section__collection":
            ...
            if ($("body").data("anim-load")) {
              ...
              sr.reveal(
                ".collection__header-media, .collection__header-info__text, .collection-empty, .collection-pagination",
